...
let foodArr = [
    ...
    },
    {
        ...
        popularity: 105,
        rating: 4.1,
        tags: ["Vanilla", "Strawberry", "Chocolate"]
    }
...
function filterByProperty(property, number, type) {
    ...
    const filtered_array = foodArr.filter((food) => {
        //rating, popularity, or price
        if(type === "above") {
            if(property === "rating") {
